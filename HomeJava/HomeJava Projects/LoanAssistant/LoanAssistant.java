...
public class LoanAssistant extends JFrame
{
	...
	// analysis Label and Textarea and exit button
...
gridConstraints.gridx = 2;
gridConstraints.gridy = 3;
gridConstraints.insets = new Insets(10, 0, 0, 0); //left,right,bottom,top
...
// Default letting to compute monthly payment
